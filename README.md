...
There are 3 ways to upload sequencing data to ENA:
  ...
  2. Using the [Webin-CLI command line tool](https://ena-docs.readthedocs.io/en/latest/submit/general-guide/webin-cli.html) - This is the method used in the instrictions below, and is approporiate for large batch submissions.
